...
var Game = function() {
  ...
  //Enimies in the game.
  this.allEnemies = [];
  // Initializes enimies and add them to the allEnemies array
  this.initEnemies();
  ...
  //This is solution for moving a player on the game map
  var that = this;
...
//If player hit water then reset the player location and a player is going to lose one life.
//If player reach destination then increase a score.
...
//If total life is zero, stop a game.
...
Game.prototype.gameOver = function() {
  ...
  var zeroLifeMessage = 'You have no more lives' + '<br>';
...
var Enemy = function() {
  //Set positions of the Enimies
  this.enemyY = [60,145,230,315];
  //Enimy's position value
  this.x = -101;
...
//Render and draw the items for the game

Item.prototype.render = function() {
  ctx.drawImage(Resources.get(this.sprite), this.x, this.y);
};

//Player's helper class
...
//Reset helper item's position every three seconds.
